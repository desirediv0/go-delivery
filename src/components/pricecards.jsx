        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center">
          ...
          <div className="border-2 border-[#0891b2] rounded-3xl p-8 flex flex-col items-center">
            ...
            <div className="text-center">
              <div className="text-lg text-gray-600">Rs.</div>
              <div className="text-5xl font-bold text-[#0891b2] ">
                1599 <span className="text-3xl">*</span>
              </div>
              <div className="text-gray-600 mt-2">7 days</div>
            </div>
          ...
          <div className="border-2 border-[#0891b2] rounded-3xl p-8 flex flex-col items-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600 mt-2">30 days</div>
            </div>
